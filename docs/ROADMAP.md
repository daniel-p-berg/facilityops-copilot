...
- Its 20-entry narrative contains initial and later received-indication groups, dependencies, shared-path and pressure indications, one non-authoritative asserted-action annotation, and new post-action indications. Package context is pinned separately in the manifest. It computes no failure, changeover, containment, recovery, or conformance outcome; recovery evaluation and findings remain unimplemented.
